...
\item 
Vector\+Xcd \mbox{\hyperlink{classRootTracker_a81f1227c2436cf1a84a7b8608b683bdd}{N\+R\+C\+Tracker}} (Vector\+Xcd x, Vector\+Xcd y, std\+::function$<$ Vector\+Xcd(Vector\+Xcd)$>$ f, std\+::function$<$ Matrix\+Xcd(Vector\+Xcd)$>$ Jfy, double eps=pow(10, -\/10))
\item 
Vector\+Xcd \mbox{\hyperlink{classRootTracker_aa6467ae384a2333b03f7432da49513a0}{D\+M\+C\+Tracker}} (Vector\+Xcd xprev, Vector\+Xcd x, Vector\+Xcd y, std\+::function$<$ Matrix\+Xcd(Vector\+Xcd)$>$ Jfx, std\+::function$<$ Matrix\+Xcd(Vector\+Xcd)$>$ Jfy, double eps=0, std\+::function$<$ Vector\+Xcd(Vector\+Xcd)$>$ f=N\+U\+LL)
\item 
Vector\+Xcd \mbox{\hyperlink{classRootTracker_a73c068967c8f4403f9a0ec1c703c2be8}{N\+N\+C\+Tracker}} (Vector\+Xcd ys, Matrix\+Xcd ysols, int index)
\item 
...
{\footnotesize\ttfamily Vector\+Xcd Root\+Tracker\+::\+D\+M\+C\+Tracker (\begin{DoxyParamCaption}\item[{Vector\+Xcd}]{xprev,  }\item[{Vector\+Xcd}]{x,  }\item[{Vector\+Xcd}]{y,  }\item[{std\+::function$<$ Matrix\+Xcd(Vector\+Xcd)$>$}]{Jfx,  }\item[{std\+::function$<$ Matrix\+Xcd(Vector\+Xcd)$>$}]{Jfy,  }\item[{double}]{eps = {\ttfamily 0},  }\item[{std\+::function$<$ Vector\+Xcd(Vector\+Xcd)$>$}]{f = {\ttfamily NULL} }\end{DoxyParamCaption})}

The D\+M\+C\+Tracker uses the Davindenkos\textquotesingle{} integration method to find the solutions satisfied by the constrain equations. \mbox{\Hypertarget{classRootTracker_acc5d4b8e89ace70cee9c227f033e5a92}\label{classRootTracker_acc5d4b8e89ace70cee9c227f033e5a92}} 
...
{\footnotesize\ttfamily Vector\+Xcd Root\+Tracker\+::\+N\+N\+C\+Tracker (\begin{DoxyParamCaption}\item[{Vector\+Xcd}]{ys,  }\item[{Matrix\+Xcd}]{ysols,  }\item[{int}]{index }\end{DoxyParamCaption})}

The N\+N\+C\+Tracker uses the nearest neighbour method to identify the roots belonging to a required branch. \mbox{\Hypertarget{classRootTracker_ae13e787a2ef083592f5c8d07ac4d08bc}\label{classRootTracker_ae13e787a2ef083592f5c8d07ac4d08bc}} 
...
{\footnotesize\ttfamily Vector\+Xcd Root\+Tracker\+::\+N\+R\+C\+Tracker (\begin{DoxyParamCaption}\item[{Vector\+Xcd}]{x,  }\item[{Vector\+Xcd}]{y,  }\item[{std\+::function$<$ Vector\+Xcd(Vector\+Xcd)$>$}]{f,  }\item[{std\+::function$<$ Matrix\+Xcd(Vector\+Xcd)$>$}]{Jfy,  }\item[{double}]{eps = {\ttfamily pow(10,~-\/10)} }\end{DoxyParamCaption})}

The N\+R\+C\+Tracker uses the Newton-\/\+Raphson method iteratively to find the solutions satisfied by the constrain equations. \begin{DoxyRefDesc}{Todo}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
\item[\mbox{\hyperlink{todo__todo000006}{Todo}}]Integrate Bertini to find all the roots \end{DoxyRefDesc}
