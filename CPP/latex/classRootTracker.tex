...
\item 
Vector\+Xd \mbox{\hyperlink{classRootTracker_a115ac4873425537fdeacbbdaf1f3e9fd}{N\+N\+Tracker}} (Vector\+Xd ys, Vector\+Xd ysols)
\item 
...
\item[\mbox{\hyperlink{todo__todo000005}{Todo}}]Add chrono to profile function evaluation timings \end{DoxyRefDesc}
...
\mbox{\Hypertarget{classRootTracker_a115ac4873425537fdeacbbdaf1f3e9fd}\label{classRootTracker_a115ac4873425537fdeacbbdaf1f3e9fd}} 
...
{\footnotesize\ttfamily Vector\+Xd Root\+Tracker\+::\+N\+N\+Tracker (\begin{DoxyParamCaption}\item[{Vector\+Xd}]{ys,  }\item[{Vector\+Xd}]{ysols }\end{DoxyParamCaption})}

The N\+N\+Tracker uses the nearest neighbour method to identify the roots belonging to a required branch. The output is the selected root at each tracking step. This method assumes the existance of a solver method, {\ttfamily Solve}, which computes all the roots for given input variables, {\ttfamily x}. This function requires the specification of the space to which the variables belong to. The function expects the solutions to be ordered with all the reals together and the variables belonging to S1 together.


\begin{DoxyParams}{Parameters}
{\em ys} & The initiation of the known root of the required branch \\
\hline
{\em ysols} & All the solutions obtained by {\ttfamily Solve} \\
\hline
{\em index} & The index upto which the reals are present\\
\hline
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
\item[\mbox{\hyperlink{todo__todo000004}{Todo}}]The method currently deals only with variables belonging to R and S1. \end{DoxyRefDesc}
