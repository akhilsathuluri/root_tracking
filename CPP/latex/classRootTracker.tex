...
\item 
Vector\+Xd \mbox{\hyperlink{classRootTracker_a9179d3bacd501c9e052aaa4a664998a5}{D\+M\+Tracker}} (Vector\+Xd x, Vector\+Xd xnext, Vector\+Xd y, std\+::function$<$ Matrix\+Xd(Vector\+Xd)$>$ Jfx, std\+::function$<$ Matrix\+Xd(Vector\+Xd)$>$ Jfy, double eps=0, std\+::function$<$ Vector\+Xd(Vector\+Xd)$>$ f=N\+U\+LL)
\item 
...
\mbox{\Hypertarget{classRootTracker_a9179d3bacd501c9e052aaa4a664998a5}\label{classRootTracker_a9179d3bacd501c9e052aaa4a664998a5}} 
...
{\footnotesize\ttfamily Vector\+Xd Root\+Tracker\+::\+D\+M\+Tracker (\begin{DoxyParamCaption}\item[{Vector\+Xd}]{x,  }\item[{Vector\+Xd}]{xnext,  }\item[{Vector\+Xd}]{y,  }\item[{std\+::function$<$ Matrix\+Xd(Vector\+Xd)$>$}]{Jfx,  }\item[{std\+::function$<$ Matrix\+Xd(Vector\+Xd)$>$}]{Jfy,  }\item[{double}]{eps = {\ttfamily 0},  }\item[{std\+::function$<$ Vector\+Xd(Vector\+Xd)$>$}]{f = {\ttfamily NULL} }\end{DoxyParamCaption})}
...
This isnt working. Implement it using prevtheta like in Mathematica rather than using xnext. That should fix it. \end{DoxyRefDesc}
